...
const InputField = ({ label, name, type = "text", value, onChange, error, icon: Icon, placeholder }) => (
  <div className="relative mb-6 group">
    <label className="text-xs font-bold text-blue-400 mb-2 ml-1 flex items-center gap-2 uppercase tracking-wider">
      {Icon && <Icon size={12} />}
      {label}
    </label>
    <div className="relative">
      <input
        ...
        className={`w-full bg-black/60 border ${error ? 'border-red-500/50' : 'border-white/10'} rounded-lg px-5 py-4 text-white placeholder-slate-600 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all duration-300 group-hover:border-white/20 font-mono text-sm`}
      />
      {/* Corner Accents */}
      <div className="absolute top-0 left-0 w-2 h-2 border-t border-l border-blue-500/50 opacity-0 group-hover:opacity-100 transition-opacity" />
      ...
      <div className="absolute bottom-0 right-0 w-2 h-2 border-b border-r border-blue-500/50 opacity-0 group-hover:opacity-100 transition-opacity" />
    </div>
  ...
  <div className="relative mb-6 group">
    ...
    <div className="relative">
      <textarea
        ...
        placeholder={placeholder}
        rows="5"
        className={`w-full bg-black/60 border ${error ? 'border-red-500/50' : 'border-white/10'} rounded-lg px-5 py-4 text-white placeholder-slate-600 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all duration-300 resize-none group-hover:border-white/20 font-mono text-sm`}
      />
      {/* Corner Accents */}
      <div className="absolute top-0 left-0 w-2 h-2 border-t border-l border-blue-500/50 opacity-0 group-hover:opacity-100 transition-opacity" />
      <div className="absolute top-0 right-0 w-2 h-2 border-t border-r border-blue-500/50 opacity-0 group-hover:opacity-100 transition-opacity" />
    ...
    <div className="max-w-7xl mx-auto px-4 relative">
      ...
      <div className="grid lg:grid-cols-2 gap-12 items-start">
        ...
        >
          ...
          <div className="relative bg-black/80 backdrop-blur-xl rounded-2xl border border-white/10 p-1 overflow-hidden">
            {/* Terminal Header */}
            ...
            <div className="p-8">
              <div className="flex items-center gap-6 mb-8">
                <div className="relative">
                  ...
                  <div className="relative p-4 bg-black/50 rounded-xl border border-blue-500/30 text-blue-400">
                    <Terminal size={32} />
                  </div>
                </div>
                <div>
                  <h3 className="text-2xl font-bold text-white font-mono tracking-tight">RESUME_DATA</h3>
                  <p className="text-slate-400 text-sm font-mono mt-1 text-blue-300/70">
              ...
              <div className="space-y-4">
                <a
                  href="/Resume.pdf"
                  download="Resume.pdf"
                  className="relative overflow-hidden flex items-center justify-center gap-3 w-full py-4 bg-blue-600 hover:bg-blue-500 text-white rounded-lg font-bold font-mono tracking-wide transition-all duration-300 group/btn"
                >
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-3 w-full py-4 bg-black/50 hover:bg-white/5 border border-white/10 hover:border-blue-500/30 text-slate-300 hover:text-white rounded-lg font-mono font-medium transition-all duration-300"
                >
        ...
        >
          ...
          <div className="relative bg-black/80 backdrop-blur-xl rounded-2xl border border-white/10 p-8 shadow-2xl overflow-hidden">
