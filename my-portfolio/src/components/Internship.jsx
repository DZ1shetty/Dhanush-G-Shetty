  ...
  <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
    {project.images.map((image, idx) => (
      ...
      >
        ...
        />
        <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2 text-cyan-300 font-mono text-[11px] tracking-widest">
